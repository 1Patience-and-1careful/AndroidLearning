...
import com.hanlyjiang.androidutils.R;

/**
 * @author Miguel Catalan 
 */
...
//        showVoice(true);
    ...
    private void onVoiceClicked() {
        ...
        intent.putExtra(RecognizerIntent.EXTRA_LANGUAGE_MODEL, RecognizerIntent.LANGUAGE_MODEL_WEB_SEARCH);    // setting recognition model, optimized for short phrases 鈥� search queries
