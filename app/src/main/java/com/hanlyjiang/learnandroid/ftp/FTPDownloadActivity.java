...
import com.hanlyjiang.learnandroid.utils.FileViewer;
...
public class FTPDownloadActivity extends AppCompatActivity implements View.OnClickListener, FTPUtils.FTPDownloadCallback {
...
//        }
    ...
    public void onDownloadFinished(final String filePath) {
        ...
        RunnableUtils.postUI(new Runnable() {
            ...
            @Override
            public void run() {
                FileViewer.viewFile(FTPDownloadActivity.this, filePath);
