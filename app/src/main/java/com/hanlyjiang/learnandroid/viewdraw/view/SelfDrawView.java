...
public class SelfDrawView extends View {
    ...
    public SelfDrawView(Context context, AttributeSet attrs,
        ...
        mShadowWidth = a.getDimensionPixelOffset(R.styleable.CircleMarkTimeView_shadowWidth, dp2px(4));
        ...
        mMarkTextSize = a.getDimensionPixelOffset(R.styleable.CircleMarkTimeView_markTextSize, sp2px(28));
        mTimeTextSize = a.getDimensionPixelOffset(R.styleable.CircleMarkTimeView_timeTextSize, sp2px(28));
