...
public class ItemAdapter extends DragItemAdapter<DragData, ItemAdapter.ViewHolder> {

    private int mLayoutId;
    private int mGrabHandleId;

    public ItemAdapter(List<DragData> list, int layoutId, int grabHandleId, boolean dragOnLongPress) {
    ...
    public long getItemId(int position) {
        return mItemList.get(position).getPos();
    }
